...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference('College.count') do
      post colleges_url, params: { college: { clg_addr: @college.clg_addr, clg_code: @college.clg_code, clg_name: @college.clg_name } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { clg_addr: @college.clg_addr, clg_code: @college.clg_code, clg_name: @college.clg_name } }
